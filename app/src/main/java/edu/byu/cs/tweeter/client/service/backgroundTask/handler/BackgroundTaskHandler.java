...
import edu.byu.cs.tweeter.client.service.backgroundTask.BackgroundTask;
...
public abstract class BackgroundTaskHandler<T extends ServiceObserver> extends Handler {
    ...
    public void handleMessage(@NonNull Message msg) {
        ...
        if (success) {
            ...
            String message = getFailedMessagePrefix() + ": " +
                    msg.getData().getString(BackgroundTask.MESSAGE_KEY);
