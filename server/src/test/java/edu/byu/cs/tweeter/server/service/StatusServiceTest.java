...
public class StatusServiceTest {
    ...
    public void setup() {
        ...
        // Setup a mock DAO that will return known responses
        ...
        Mockito.when(mockStoryDAO.getStory()).thenReturn(expectedResponse);

        statusServiceSpy = Mockito.spy(StatusService.class);
        Mockito.when(statusServiceSpy.getStoryDAO(Mockito.any(),Mockito.anyInt(),)).thenReturn(mockStoryDAO);
    }
